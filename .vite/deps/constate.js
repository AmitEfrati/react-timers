...
function createUseContext(context) {
  return function() {
    ...
    if (isDev && value === NO_PROVIDER) {
      var warnMessage = context.displayName ? "The context consumer of " + context.displayName + " must be wrapped with its corresponding Provider" : "Component must be wrapped with Provider.";
...
function constate(useValue) {
  ...
  var createContext$1 = function createContext$12(displayName) {
    var context = (0, import_react.createContext)(NO_PROVIDER);
  ...
  var Provider = function Provider2(_ref) {
    ...
    for (var i = 0; i < contexts.length; i += 1) {
      ...
      element = (0, import_react.createElement)(context.Provider, {
...
var constate_es_default = constate;
export {
  constate_es_default as default
};
//# sourceMappingURL=constate.js.map
